...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220116_cakeshop_3132af09785f72af9409_20220116165835_archive.zip';
	const ARCHIVE_SIZE		 = '42377210';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '3132af0-16165835';
    const SECONDARY_PACKAGE_HASH = '6f40b68-16165835';
	const VERSION			 = '1.4.3';
