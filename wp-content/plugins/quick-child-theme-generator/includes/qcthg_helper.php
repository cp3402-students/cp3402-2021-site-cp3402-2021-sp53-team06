...
if(!class_exists('QCTHG_Helper'))
{
    class QCTHG_Helper
    {
         ...
         * @return [string]
         */
        public function qcthgRefSanitizeText($text)
        {
            if(empty($text)) { return; }
            $trimedText = trim($text);
         ...
         * @param  $cookieValue
         */
        public function qcthgSetCookies($cookieName, $cookieValue)
        {
            if(empty($cookieName)) {
         ...
         */
        public function adminNoticeError() {
            ?>
         ...
         * @param  $body
         */
        public function qcthgLogCall($body)
        {
         ...
         * @return [boolean]
         */
        public function qcthgChkTemplateName($templateName)
        {
         ...
         * @return [boolean]
         */
        public function findHeaderFooter($fileNm, $scanPath)
        {
            $find = false;
