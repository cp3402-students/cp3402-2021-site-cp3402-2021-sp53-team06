...
if(!class_exists('QCTHG_Main'))
{
    class QCTHG_Main
    {
        ...
        public function qcthgInitialization()
        {
            ...
            add_action('admin_menu', array('QCTHG_Main', 'qcthgPluginMenu'));
            add_action('admin_init', array('QCTHG_Main', 'qcthgRegisterAssets'));
            add_action('admin_enqueue_scripts', array('QCTHG_Main', 'qcthgEnqueueAssets'));
            add_action('admin_post_qcthg_create_theme', array('QCTHG_Main', 'qcthgCreateChildTheme'));
            add_action('admin_post_qcthg_create_template', array('QCTHG_Main', 'qcthgCreateBlankTemplate'));
        ...
        public function qcthgPluginMenu()
        {
            add_menu_page(
                ...
                'manage_options',
                'quick-child-theme-generator',
                array('QCTHG_Main', 'qcthgMenuPage'),
                'dashicons-groups',
                60
            );
            ...
            add_submenu_page(
                ...
                array('QCTHG_Main', 'qcthgSubMenuTemplatePage'),
                1
            );
        ...
        public function qcthgEnqueueAssets($hook)
        {
            ...
            || $_GET['page'] === 'quick-child-theme-generator'
            || $_GET['page'] === 'quick-blank-template-generator') {
        ...
        public function qcthgCreateChildTheme()
        {
            if(!empty($_POST)) {
				if(!isset($_POST['_wpnonce']) || !wp_verify_nonce($_POST['_wpnonce'], 'qcthg_create_theme')) {
                    ...
                    $themeGenOutput = QCTHG_Main::qcthgGenerateChildAssets($postedData);
        ...
        public function qcthgGenerateChildAssets($data)
        {
            ...
            if(wp_mkdir_p($newChildThemePath)) {
                ...
                $result['stylesheet'] = QCTHG_Main::qcthgCreateStylesheet($newChildThemePath, $data, $themeTitle);
                $result['functions_php'] = QCTHG_Main::qcthgCreateFunctionPhp($newChildThemePath, $refThemeTitle);
                $result['screenshot'] = QCTHG_Main::qcthgCopyScreenshot($parntThemePath, $newChildThemePath);
                return $result;
        ...
        public function qcthgCreateBlankTemplate()
        {
            if(!empty($_POST)) {
				if(!isset($_POST['_wpnonce']) || !wp_verify_nonce($_POST['_wpnonce'], 'qcthg_create_template')) {
                    ...
                    QCTHG_Main::qcthgGenerateTemplateAssets($postedData);
        ...
        public function qcthgGenerateTemplateAssets($data)
        {
            ...
            $result['template'] = QCTHG_Main::qcthgCreateBlankTemplatePhp($childThemeDir, $refTemplateNameLowerCase, $templateName, $headerFileNm, $footerFileNm);
            return $result;
        }
